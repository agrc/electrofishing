define([
  ...
  return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, _GridMixin, _ClearValuesMixin], {
    ...
    postCreate: function () {
      ...
      this.controlMappings = [[this.collectionPartSelect, 'COLLECTION_PART']];
    ...
    show: function (guid, tabName) {
      ...
      domClass.add(query('#' + tabName, this.domNode)[0], 'active in');
    ...
    onSubmitClick: function () {
      ...
      this.dietData[this.currentFishId] = array.map(
        this.getGridData(),
        function (record) {
    ...
    getData: function (type) {
      ...
      for (var fishId in this[type + 'Data']) {
        if (this[type + 'Data'].hasOwnProperty(fishId)) {
          ...
          data = data.concat(
            this[type + 'Data'][fishId].map(function (record) {
