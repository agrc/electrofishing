require(['react-app/config', 'app/habitat/Habitat', 'dojo/dom-class', 'dojo/dom-construct'], function (
  config,
  Habitat,
  ...
  describe('app/habitat/Habitat', function () {
    ...
    describe('onSedimentClassChange', function () {
      it('updates total and css', function () {
        ...
        expect(domClass.contains(testWidget.sedTotalSpan.parentElement, 'text-success')).toBe(true);
        expect(domClass.contains(testWidget.sedTotalSpan.parentElement, 'text-danger')).toBe(false);
        ...
        expect(domClass.contains(testWidget.sedTotalSpan.parentElement, 'text-success')).toBe(false);
        expect(domClass.contains(testWidget.sedTotalSpan.parentElement, 'text-danger')).toBe(true);
