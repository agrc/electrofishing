require(['react-app/config', 'app/StreamSearch', 'dojo/dom-construct', 'dojo/_base/window'], function (
  config,
  StreamSearch,
  ...
  describe('app/StreamSearch', function () {
    ...
    describe('_processResults', function () {
      ...
      it('adds a reference to the source layer for each feature', function () {
        ...
        expect(testWidget._populateTable.calls.mostRecent().args[0][0].queryUrl).toMatch(
          config.urls.streamsFeatureService
        );
      });
    });
  });
