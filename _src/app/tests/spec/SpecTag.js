require(['app/catch/Tag', 'react-app/config', 'dojo/dom-class', 'dojo/dom-construct', 'dojo/_base/window'], function (
  Tag,
  config,
  ...
  describe('app/catch/Tag', function () {
    ...
    describe('setData', function () {
      ...
      var isMinus = function () {
        return (
          domClass.contains(testWidget.icon, testWidget.minusIconClass) &&
