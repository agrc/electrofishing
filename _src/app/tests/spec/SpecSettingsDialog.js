require(['react-app/config', 'dojo/dom-construct', 'stubmodule'], function (
  config,
  ...
  describe('app/SettingsDialog', function () {
    ...
    describe('onCoordTypeChange', function () {
      it('should call topic.publish with correct topic from config', function () {
        ...
        expect(topicMock.publishSync.calls.mostRecent().args[0]).toEqual(config.topics.coordTypeToggle_onChange);
      });
