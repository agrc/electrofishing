define([
  ...
  return declare([_WidgetBase, _TemplatedMixin], {
    ...
    _search: function (searchString) {
      ...
      this.query.query.where = 'UPPER(' + this.searchField + ") LIKE UPPER('" + searchString + "%')";
      ...
      this.promises = all(promises).then(
    ...
    _setMatch: function (row) {
      ...
      if (contextValue.length > 0) {
        this.query.query.where =
          this.searchField + " = '" + this.textBox.value + "' AND " + this.contextField + " = '" + contextValue + "'";
      } else {
        this.query.query.where =
          this.searchField + " = '" + this.textBox.value + "' AND " + this.contextField + ' IS NULL';
      }
