define(['agrc/modules/Domains', 'react-app/config', 'app/OtherOptionHandler', 'dojo/dom-construct'], function (
  agrcDomains,
  ...
  return {
    ...
    populateSelectWithDomainValues: function (select, featureServiceUrl, fieldName) {
      ...
      return agrcDomains.populateSelectWithDomainValues.apply(this, [select, featureServiceUrl, fieldName]);
    },
